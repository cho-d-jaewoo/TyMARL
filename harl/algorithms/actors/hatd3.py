"""
HATD3 — Heterogeneous-Agent reinforcement learning algorithm
...
try:
    from harl.algorithms.actors.hatd3 import HATD3  # type: ignore[import-not-found]
except ImportError as e:  # pragma: no cover
    raise ImportError(
        "HATD3 is provided by the upstream HARL repository. "

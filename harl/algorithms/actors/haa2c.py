"""
HAA2C — Heterogeneous-Agent reinforcement learning algorithm
...
try:
    from harl.algorithms.actors.haa2c import HAA2C  # type: ignore[import-not-found]
except ImportError as e:  # pragma: no cover
    raise ImportError(
        "HAA2C is provided by the upstream HARL repository. "
